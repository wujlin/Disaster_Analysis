...
- `Data/Moldova Flooding Sept 16 2024/network coverage/**/*.csv`
- （可选）`outputs/moldova_flooding_2024/population_redistribution/tables/redistribution_by_distance_band.csv`
