...
- `Data/The Park Fire in Northern California, US/network coverage/**/*.csv`
- （可选）`outputs/park_fire_2024/population_redistribution/tables/redistribution_by_distance_band.csv`
